...
![TGDP Outlier Values](images\outlier.png)

### Seasonal Distribution of Singapore's GDP

![Seasonal_Distribution](images\seasonal.png)

### Seasonal Decomposition of Singapore's GDP

![SeasonalDecomposition](images\timeDecomp.png)
...
![PrePruning](images\prePrune.png)

**AFTER PRUNING: 114 rows**

![PostPruning](images\postPrune.png)
...
![Differencing](images\differencing.png)
...
![LinearRegression](images\regResult.png)
...
![SARIMAXmodel](images\sarimaxResults.png)
...
![ProphetModel](images\prophetResult.png)
